...
OBJ = build/main.o build/vm.o build/asmlex.o build/assemble.o build/spylib.o build/capi_io.o build/capi_load.o build/capi_memory.o
...
build/capi_memory.o:
	$(CC) $(CF) -c capi_memory.c -o build/capi_memory.o
